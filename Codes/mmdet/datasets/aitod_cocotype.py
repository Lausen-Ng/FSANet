...
class AITODCOCODataset(CustomDataset):
    ...
    def evaluate(self,
        ...
        for metric in metrics:
            ...
            cocoEval.params.maxDets = [1000, 1000, 1500]
            cocoEval.params.areaRng = [[0 ** 2, 1e5 ** 2], [0 ** 2, 8 ** 2],
                                       [8 ** 2, 16 ** 2], [16 ** 2, 32 ** 2], [32 ** 2, 1e5 ** 2]]
            cocoEval.params.areaRngLbl = ['all', 'very_tiny', 'tiny', 'small', 'medium']
            ...
            if metric == 'proposal':
                ...
                # cocoEval.summarize()
                # 参考链接
                # https://github.com/open-mmlab/mmdetection/pull/6505/commits/b38a4f22ad6daa919d820ab6b509641ca4cbacde#
